...
SWEP.ViewModel				= "models/weapons/btb/v_acr.mdl"
SWEP.WorldModel				= "models/weapons/btb/w_acr.mdl"
SWEP.HoldType				= "smg"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound				= Sound("BTB_ACR.Fire")
...
SWEP.Offset = {
	...
	Forward = 0.5, 	-- Y Axis	(Back/Forward)
	},
	Ang = 
	{
