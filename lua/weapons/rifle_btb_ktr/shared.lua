...
SWEP.ViewModel				= "models/weapons/btb/v_ktr.mdl"
SWEP.WorldModel				= "models/weapons/btb/w_ktr.mdl"
SWEP.HoldType				= "ar2"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound				= Sound("BTB_KTR.Fire")
SWEP.Primary.Round				= ("zooks_7.62x39_tracer")
...
SWEP.ShellDelay 		= 0
SWEP.ShellEffect 		= "sim_shelleject_fas_762x39"
