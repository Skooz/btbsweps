...
SWEP.ViewModel					= "models/weapons/btb/v_f2000.mdl"
SWEP.WorldModel					= "models/weapons/btb/w_f2000.mdl"
SWEP.HoldType					= "smg"
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= true

SWEP.Primary.Sound				= Sound("BTB_F2000.Fire")
...
SWEP.Offset = {
	...
	Forward = 1.2, 	-- Y Axis	(Back/Forward)
	},
	Ang = 
	{
