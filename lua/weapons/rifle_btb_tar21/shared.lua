...
SWEP.ViewModel				= "models/weapons/btb/v_tar21.mdl"
SWEP.WorldModel				= "models/weapons/btb/w_tar21.mdl"
SWEP.HoldType				= "ar2"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound				= Sound("BTB_TAR21.Fire")
