...
SWEP.ViewModel					= "models/weapons/btb/v_ump45.mdl"
SWEP.WorldModel					= "models/weapons/btb/w_ump45.mdl"
SWEP.HoldType					= "smg"
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= true

SWEP.Primary.Sound				= Sound("BTB_UMP45.Fire")
...
SWEP.Primary.KickHorizontal		= 1.25				// Maximum up recoil (stock)
