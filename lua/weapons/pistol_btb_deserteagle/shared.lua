...
SWEP.ViewModel				= "models/weapons/btb/v_deserteagle.mdl"
SWEP.WorldModel				= "models/weapons/btb/w_deserteagle.mdl"
SWEP.HoldType				= "pistol"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound				= Sound("BTB_DesertEagle.Fire")
SWEP.Primary.Round				= ("zooks_12.7x33_420")
...
SWEP.ShellDelay = 0
SWEP.ShellEffect = "sim_shelleject_fas_50ae"
