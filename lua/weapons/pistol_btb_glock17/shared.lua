...
SWEP.ViewModel					= "models/weapons/btb/v_glock17.mdl"
SWEP.WorldModel					= "models/weapons/btb/w_glock.mdl"
SWEP.HoldType					= "pistol"
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= true

SWEP.Primary.Sound				= Sound("BTB_GLOCK17.Fire")
SWEP.Primary.Round				= ("zooks_9x19_350")
