...
SWEP.ViewModel					= "models/weapons/btb/v_mp5.mdl"
SWEP.WorldModel					= "models/weapons/btb/w_mp5.mdl"
SWEP.HoldType					= "smg"
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= true

SWEP.Primary.Sound				= Sound("BTB_MP5.Fire")
...
SWEP.Primary.KickHorizontal		= 1.2							// Maximum up recoil (stock)
...
SWEP.Offset = {
	Pos = 
	{
	Up = 5.5,  		-- Z Axis	(Up/Down)
	Right = -1, 		-- X Axis	(Left/Right)
	Forward = 4, 	-- Y Axis	(Back/Forward)
	},
	Ang = 
	{
