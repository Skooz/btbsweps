...
SWEP.ViewModel					= "models/weapons/btb/v_g3a4.mdl"
SWEP.WorldModel					= "models/weapons/btb/w_g3a4.mdl"
SWEP.HoldType					= "ar2"
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= true

SWEP.Primary.Sound				= Sound("BTB_G3A4.Fire")
